...
public class AuthApplicationDefConfig {
    ...
    public ApplicationDef findByOrgIdAndAppId(String orgId, String appId) throws RouterException
    {
        ...
        if (!applicationDefConfig.isPresent()) {
            throw new RouterException(AuthRouterResponseCode.APPID_DEF_NOT_FOUND, (Exception) null, ConstantsAuth.ROUTER_ERROR_TYPE_VALIDATION, "Given OrgId and AppId is not registered");
        }
        ...
        try
        {
            ...
            throw new RouterException(AuthRouterResponseCode.APPID_DEF_NOT_FOUND, (Exception) null, ConstantsAuth.ROUTER_ERROR_TYPE_VALIDATION, "No valid configuration found for given orgId and appId");
        }
    }
}
