...
public class AuthCryptoUtilV2 {
    ...
    private static final Logger logger = LogManager.getLogger ( AuthCryptoUtilV2.class );
    ...
    public static SecretKey getSecretAESKeyAsString (String salt, String passphrase) throws RouterException {
